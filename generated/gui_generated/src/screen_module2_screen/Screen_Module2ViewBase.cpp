...
Screen_Module2ViewBase::Screen_Module2ViewBase() :
    buttonCallback(this, &Screen_Module2ViewBase::buttonCallbackHandler),
    sliderValueChangedCallback(this, &Screen_Module2ViewBase::sliderValueChangedCallbackHandler)
{
    CanvasWidgetRenderer::setupBuffer(canvasBuffer, CANVAS_BUFFER_SIZE);

    backgroundBox_Module2.setPosition(0, 0, 800, 480);
    backgroundBox_Module2.setColor(touchgfx::Color::getColorFrom24BitRGB(0, 0, 0));
    ...
    buttonWithLabel_GoToMainMenu.setLabelText(TypedText(T_SINGLEUSEID67));
    ...
    Unicode::snprintf(textArea_CPU_UsageBuffer, TEXTAREA_CPU_USAGE_SIZE, "%s", TypedText(T_SINGLEUSEID96).getText());
    textArea_CPU_Usage.setWildcard(textArea_CPU_UsageBuffer);
    textArea_CPU_Usage.setTypedText(TypedText(T_SINGLEUSEID95));
    ...
    Unicode::snprintf(textArea_CRCBuffer, TEXTAREA_CRC_SIZE, "%s", TypedText(T_SINGLEUSEID84).getText());
    textArea_CRC.setWildcard(textArea_CRCBuffer);
    textArea_CRC.setTypedText(TypedText(T_SINGLEUSEID83));
    ...
    Unicode::snprintf(textArea_ValueBuffer, TEXTAREA_VALUE_SIZE, "%s", TypedText(T_SINGLEUSEID86).getText());
    textArea_Value.setWildcard(textArea_ValueBuffer);
    textArea_Value.setTypedText(TypedText(T_SINGLEUSEID85));
    ...
    Unicode::snprintf(textArea_ParameterIDBuffer, TEXTAREA_PARAMETERID_SIZE, "%s", TypedText(T_SINGLEUSEID88).getText());
    textArea_ParameterID.setWildcard(textArea_ParameterIDBuffer);
    textArea_ParameterID.setTypedText(TypedText(T_SINGLEUSEID87));
    ...
    Unicode::snprintf(textArea_ModuleIDBuffer, TEXTAREA_MODULEID_SIZE, "%s", TypedText(T_SINGLEUSEID90).getText());
    textArea_ModuleID.setWildcard(textArea_ModuleIDBuffer);
    textArea_ModuleID.setTypedText(TypedText(T_SINGLEUSEID89));
    ...
    Unicode::snprintf(textArea_SourceIDBuffer, TEXTAREA_SOURCEID_SIZE, "%s", TypedText(T_SINGLEUSEID92).getText());
    textArea_SourceID.setWildcard(textArea_SourceIDBuffer);
    textArea_SourceID.setTypedText(TypedText(T_SINGLEUSEID91));
    ...
    textArea_Title.setTypedText(TypedText(T_SINGLEUSEID64));
    ...
    buttonWithLabel_SetValue.setLabelText(TypedText(T_SINGLEUSEID117));
    ...
    textArea_Parameter2.setTypedText(TypedText(T_SINGLEUSEID118));
    ...
    textArea_Parameter1.setTypedText(TypedText(T_SINGLEUSEID119));
    ...
    Unicode::snprintf(textArea_ValueToSetBuffer, TEXTAREA_VALUETOSET_SIZE, "%s", TypedText(T_SINGLEUSEID121).getText());
    textArea_ValueToSet.setWildcard(textArea_ValueToSetBuffer);
    textArea_ValueToSet.setTypedText(TypedText(T_SINGLEUSEID120));
    ...
    textArea_ParameterToSet.setTypedText(TypedText(T_SINGLEUSEID122));

    add(backgroundBox_Module2);
...
void Screen_Module2ViewBase::setupScreen()
{

}

void Screen_Module2ViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void Screen_Module2ViewBase::sliderValueChangedCallbackHandler(const touchgfx::Slider& src, int value)
{
    if (&src == &slider_Value)
    {
