...
/*********************************************************************************/
#ifndef SCREEN_MODULE2_VIEW_BASE_HPP
#define SCREEN_MODULE2_VIEW_BASE_HPP
...
class Screen_Module2ViewBase : public touchgfx::View<Screen_Module2Presenter>
{
public:
    Screen_Module2ViewBase();
    virtual ~Screen_Module2ViewBase() {}
    ...
    {
        // Override and implement this function in Screen_Module2View
    }
...
protected:
     ...
     * Member Declarations
     */
    touchgfx::Box backgroundBox_Module2;
...
private:
     ...
     */
    touchgfx::Callback<Screen_Module2ViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Screen_Module2ViewBase, const touchgfx::Slider&, int> sliderValueChangedCallback;
...
#endif // SCREEN_MODULE2_VIEW_BASE_HPP
