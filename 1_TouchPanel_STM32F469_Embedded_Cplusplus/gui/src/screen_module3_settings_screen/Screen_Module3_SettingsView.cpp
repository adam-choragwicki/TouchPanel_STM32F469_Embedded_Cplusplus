...
Screen_Module3_SettingsView::Screen_Module3_SettingsView()
{
#ifndef SIMULATOR     
  ...
  for(int i=0; i< SETTABLE_PARAMETER_NAME_COUNT; i++)
  {
    ...
    {
      settableParameterNameStringDisplay[i][character] = Model::m_InitParametersModule3[i + SETTABLE_PARAMETER_NAME_OFFSET][character];
    }
  }
  ...
  for(int i=0; i< SETTABLE_PARAMETER_VALUE_COUNT; i++)
  {
    for (int character = 0; character < PAYLOAD_SIZE; character++)
    {
      m_SettableParameterValues[i][character] = Model::m_InitParametersModule3[i + SETTABLE_PARAMETER_VALUE_OFFSET][character];
    }
...
void Screen_Module3_SettingsView::setupScreen()
{
...
void Screen_Module3_SettingsView::tearDownScreen()
{
...
void Screen_Module3_SettingsView::RadioButtonParameter1Selected()
{
...
void Screen_Module3_SettingsView::RadioButtonParameter2Selected()
{
...
void Screen_Module3_SettingsView::RadioButtonParameter3Selected()
{
...
void Screen_Module3_SettingsView::RadioButtonParameter4Selected()
{
...
void Screen_Module3_SettingsView::RadioButtonParameter5Selected()
{
...
void Screen_Module3_SettingsView::RadioButtonParameter6Selected()
{
...
void Screen_Module3_SettingsView::RadioButtonParameter7Selected()
{
...
void Screen_Module3_SettingsView::RadioButtonParameter8Selected()
{
...
void Screen_Module3_SettingsView::RadioButtonParameter9Selected()
{
...
void Screen_Module3_SettingsView::RadioButtonParameter10Selected()
{
...
void Screen_Module3_SettingsView::SetScrollWheelValues(int parameterIndex)
{
...
void Screen_Module3_SettingsView::TranslateAsciiValuesToScrollWheelPositionsToAsciiValues(const uint8_t values[], int positions[])
{
  for (int i = 0; i < PAYLOAD_SIZE; i++)
  {
    switch (values[i])
...
void Screen_Module3_SettingsView::SetValueSign(const uint8_t valueString[])
{
