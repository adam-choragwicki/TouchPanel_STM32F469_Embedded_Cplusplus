...
Screen_Module3_SignalsView::Screen_Module3_SignalsView()
{
  ...
  long long int bottom = Screen_Module3_GraphView::m_GraphRangeBottom;
  ...
  long long int top = Screen_Module3_GraphView::m_GraphRangeTop;
...
void Screen_Module3_SignalsView::SetMinScrollWheelValues(long long int bottom)
{
...
void Screen_Module3_SignalsView::SetMaxScrollWheelValues(long long int top)
{
  long long int rest = 0;
...
void Screen_Module3_SignalsView::TranslateScrollWheelPositionsToAsciiValues(int const positions[], char values[])
{
...
void Screen_Module3_SignalsView::UpdateTimeRange(int value)
{
  Screen_Module3_GraphView::m_GraphRangeRight = value * SINE_PERIOD_DEGREES;
  
  /*Update time range value*/
  Unicode::snprintf(textArea_TimeRangeBuffer, TEXTAREA_TIMERANGE_SIZE, "%d", Screen_Module3_GraphView::m_GraphRangeRight);
  textArea_TimeRange.invalidate();
}
