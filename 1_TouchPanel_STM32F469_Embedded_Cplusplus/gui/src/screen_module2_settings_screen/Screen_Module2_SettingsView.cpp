...
Screen_Module2_SettingsView::Screen_Module2_SettingsView()
{
  ...
  for(int i=0; i< SETTABLE_PARAMETER_NAME_COUNT; i++)
  {
    ...
    {
      settableParameterNameStringDisplay[i][character] = Model::m_InitParametersModule2[i + SETTABLE_PARAMETER_NAME_OFFSET][character];
    }
  }
  ...
  for(int i=0; i< SETTABLE_PARAMETER_VALUE_COUNT; i++)
  {
    for (int character = 0; character < PAYLOAD_SIZE; character++)
    {
      m_SettableParameterValues[i][character] = Model::m_InitParametersModule2[i + SETTABLE_PARAMETER_VALUE_OFFSET][character];
    }
...
void Screen_Module2_SettingsView::SetNewValue()
{
  ...
  uartPacket.SetModule(ModuleID::MODULE2);
...
void Screen_Module2_SettingsView::GetScrollWheelsPositions(int positions[])
{
...
void Screen_Module2_SettingsView::TranslateScrollWheelPositionsToAsciiValues(const int positions[], char values[])
{
...
void Screen_Module2_SettingsView::EnableParameterButtonPushed()
{
...
void Screen_Module2_SettingsView::DisableParameterButtonPushed()
{
  /*Structure used to propagate UART packet contents up to Model class*/
  UartPacket uartPacket;
...
void Screen_Module2_SettingsView::RadioButtonParameter1Selected()
{
...
void Screen_Module2_SettingsView::RadioButtonParameter2Selected()
{
...
void Screen_Module2_SettingsView::RadioButtonParameter3Selected()
{
...
void Screen_Module2_SettingsView::RadioButtonParameter4Selected()
{
...
void Screen_Module2_SettingsView::RadioButtonParameter5Selected()
{
...
void Screen_Module2_SettingsView::RadioButtonParameter6Selected()
{
...
void Screen_Module2_SettingsView::RadioButtonParameter7Selected()
{
...
void Screen_Module2_SettingsView::RadioButtonParameter8Selected()
{
...
void Screen_Module2_SettingsView::RadioButtonParameter9Selected()
{
...
void Screen_Module2_SettingsView::RadioButtonParameter10Selected()
{
...
void Screen_Module2_SettingsView::SetScrollWheelValues(int parameterIndex)
{
...
void Screen_Module2_SettingsView::TranslateAsciiValuesToScrollWheelPositionsToAsciiValues(const uint8_t values[], int positions[])
{
  for (int i = 0; i < PAYLOAD_SIZE; i++)
  {
    switch (values[i])
...
void Screen_Module2_SettingsView::SetValueSign(const uint8_t valueString[])
{
