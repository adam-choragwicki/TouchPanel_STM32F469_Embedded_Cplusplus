...
Screen_Module2_SignalsViewBase::Screen_Module2_SignalsViewBase() :
    buttonCallback(this, &Screen_Module2_SignalsViewBase::buttonCallbackHandler),
    sliderValueChangedCallback(this, &Screen_Module2_SignalsViewBase::sliderValueChangedCallbackHandler),
    updateItemCallback(this, &Screen_Module2_SignalsViewBase::updateItemCallbackHandler)
{
    ...
    textArea_Title.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1569));
    ...
    Unicode::snprintf(textArea_CPU_UsageBuffer, TEXTAREA_CPU_USAGE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1571).getText());
    textArea_CPU_Usage.setWildcard(textArea_CPU_UsageBuffer);
    textArea_CPU_Usage.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1570));
    ...
    buttonWithLabel_Back.setLabelText(touchgfx::TypedText(T_SINGLEUSEID1572));
    ...
    Unicode::snprintf(textArea_TimeRangeBuffer, TEXTAREA_TIMERANGE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1574).getText());
    textArea_TimeRange.setWildcard(textArea_TimeRangeBuffer);
    textArea_TimeRange.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1573));
    ...
    textArea_Y_AxisMax.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1575));
    ...
    textArea_Y_AxisMin.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1576));
    ...
    textArea_Auto_Y_Range.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1577));
    ...
    Unicode::snprintf(textArea_Parameter4NameBuffer, TEXTAREA_PARAMETER4NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1579).getText());
    textArea_Parameter4Name.setWildcard(textArea_Parameter4NameBuffer);
    textArea_Parameter4Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1578));
    ...
    Unicode::snprintf(textArea_Parameter3NameBuffer, TEXTAREA_PARAMETER3NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1581).getText());
    textArea_Parameter3Name.setWildcard(textArea_Parameter3NameBuffer);
    textArea_Parameter3Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1580));
    ...
    Unicode::snprintf(textArea_Parameter2NameBuffer, TEXTAREA_PARAMETER2NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1583).getText());
    textArea_Parameter2Name.setWildcard(textArea_Parameter2NameBuffer);
    textArea_Parameter2Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1582));
    ...
    Unicode::snprintf(textArea_Parameter1NameBuffer, TEXTAREA_PARAMETER1NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1585).getText());
    textArea_Parameter1Name.setWildcard(textArea_Parameter1NameBuffer);
    textArea_Parameter1Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1584));
    ...
    buttonWithLabel_SetRanges.setLabelText(touchgfx::TypedText(T_SINGLEUSEID1586));
...
void Screen_Module2_SignalsViewBase::setupScreen()
{
...
void Screen_Module2_SignalsViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    {
        //Interaction_GoBack
        //When buttonWithLabel_Back clicked change screen to Screen_Module2_Graph
...
void Screen_Module2_SignalsViewBase::sliderValueChangedCallbackHandler(const touchgfx::Slider& src, int value)
{
...
void Screen_Module2_SignalsViewBase::updateItemCallbackHandler(touchgfx::DrawableListItemsInterface* items, int16_t containerIndex, int16_t itemIndex)
{
