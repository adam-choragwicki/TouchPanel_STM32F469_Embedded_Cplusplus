...
Screen_Module3_SignalsViewBase::Screen_Module3_SignalsViewBase() :
    buttonCallback(this, &Screen_Module3_SignalsViewBase::buttonCallbackHandler),
    ...
    updateItemCallback(this, &Screen_Module3_SignalsViewBase::updateItemCallbackHandler)
{
    ...
    textArea_Title.setTypedText(touchgfx::TypedText(T_SINGLEUSEID6201));
    ...
    Unicode::snprintf(textArea_CPU_UsageBuffer, TEXTAREA_CPU_USAGE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID6203).getText());
    textArea_CPU_Usage.setWildcard(textArea_CPU_UsageBuffer);
    textArea_CPU_Usage.setTypedText(touchgfx::TypedText(T_SINGLEUSEID6202));
    ...
    buttonWithLabel_Back.setLabelText(touchgfx::TypedText(T_SINGLEUSEID6204));
    ...
    Unicode::snprintf(textArea_TimeRangeBuffer, TEXTAREA_TIMERANGE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID6206).getText());
    textArea_TimeRange.setWildcard(textArea_TimeRangeBuffer);
    textArea_TimeRange.setTypedText(touchgfx::TypedText(T_SINGLEUSEID6205));
    ...
    textArea_Y_AxisMax.setTypedText(touchgfx::TypedText(T_SINGLEUSEID6207));
    ...
    textArea_Y_AxisMin.setTypedText(touchgfx::TypedText(T_SINGLEUSEID6208));
    ...
    textArea_Auto_Y_Range.setTypedText(touchgfx::TypedText(T_SINGLEUSEID6209));
    ...
    Unicode::snprintf(textArea_Parameter4NameBuffer, TEXTAREA_PARAMETER4NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID6211).getText());
    textArea_Parameter4Name.setWildcard(textArea_Parameter4NameBuffer);
    textArea_Parameter4Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID6210));
    ...
    Unicode::snprintf(textArea_Parameter3NameBuffer, TEXTAREA_PARAMETER3NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID6213).getText());
    textArea_Parameter3Name.setWildcard(textArea_Parameter3NameBuffer);
    textArea_Parameter3Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID6212));
    ...
    Unicode::snprintf(textArea_Parameter2NameBuffer, TEXTAREA_PARAMETER2NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID6215).getText());
    textArea_Parameter2Name.setWildcard(textArea_Parameter2NameBuffer);
    textArea_Parameter2Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID6214));
    ...
    Unicode::snprintf(textArea_Parameter1NameBuffer, TEXTAREA_PARAMETER1NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID6217).getText());
    textArea_Parameter1Name.setWildcard(textArea_Parameter1NameBuffer);
    textArea_Parameter1Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID6216));
    ...
    buttonWithLabel_SetRanges.setLabelText(touchgfx::TypedText(T_SINGLEUSEID6218));
...
void Screen_Module3_SignalsViewBase::setupScreen()
{
...
void Screen_Module3_SignalsViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    {
        //Interaction_GoBack
        //When buttonWithLabel_Back clicked change screen to Screen_Module3_Graph
        //Go to Screen_Module3_Graph with no screen transition
        application().gotoScreen_Module3_GraphScreenNoTransition();
    }
...
void Screen_Module3_SignalsViewBase::sliderValueChangedCallbackHandler(const touchgfx::Slider& src, int value)
{
...
void Screen_Module3_SignalsViewBase::updateItemCallbackHandler(touchgfx::DrawableListItemsInterface* items, int16_t containerIndex, int16_t itemIndex)
{
