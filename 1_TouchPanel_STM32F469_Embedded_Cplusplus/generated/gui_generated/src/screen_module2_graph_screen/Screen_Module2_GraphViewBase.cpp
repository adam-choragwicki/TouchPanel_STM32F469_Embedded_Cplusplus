    ...
    buttonCallback(this, &Screen_Module2_GraphViewBase::buttonCallbackHandler)
{
    ...
    Unicode::snprintf(textArea_CPU_UsageBuffer, TEXTAREA_CPU_USAGE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1258).getText());
    textArea_CPU_Usage.setWildcard(textArea_CPU_UsageBuffer);
    textArea_CPU_Usage.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1257));
    ...
    buttonWithLabel_Back.setLabelText(touchgfx::TypedText(T_SINGLEUSEID1259));
    ...
    Unicode::snprintf(textArea_GraphRangeTopBuffer, TEXTAREA_GRAPHRANGETOP_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1261).getText());
    textArea_GraphRangeTop.setWildcard(textArea_GraphRangeTopBuffer);
    textArea_GraphRangeTop.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1260));
    ...
    Unicode::snprintf(textArea_GraphRangeBottomBuffer, TEXTAREA_GRAPHRANGEBOTTOM_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1263).getText());
    textArea_GraphRangeBottom.setWildcard(textArea_GraphRangeBottomBuffer);
    textArea_GraphRangeBottom.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1262));
    ...
    Unicode::snprintf(textArea_GraphRangeLeftBuffer, TEXTAREA_GRAPHRANGELEFT_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1265).getText());
    textArea_GraphRangeLeft.setWildcard(textArea_GraphRangeLeftBuffer);
    textArea_GraphRangeLeft.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1264));
    ...
    Unicode::snprintf(textArea_GraphRangeRightBuffer, TEXTAREA_GRAPHRANGERIGHT_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID1267).getText());
    textArea_GraphRangeRight.setWildcard(textArea_GraphRangeRightBuffer);
    textArea_GraphRangeRight.setTypedText(touchgfx::TypedText(T_SINGLEUSEID1266));
    ...
    buttonWithLabel_Signals.setLabelText(touchgfx::TypedText(T_SINGLEUSEID1268));
...
void Screen_Module2_GraphViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    else if (&src == &buttonWithLabel_Signals)
    {
        ...
        //When buttonWithLabel_Signals clicked change screen to Screen_Module2_Signals
        //Go to Screen_Module2_Signals with no screen transition
        application().gotoScreen_Module2_SignalsScreenNoTransition();
    }
}
