    ...
    buttonCallback(this, &Screen_Module3_DataViewBase::buttonCallbackHandler)
{
    ...
    Unicode::snprintf(textArea_CPU_UsageBuffer, TEXTAREA_CPU_USAGE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4846).getText());
    textArea_CPU_Usage.setWildcard(textArea_CPU_UsageBuffer);
    textArea_CPU_Usage.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4845));
    ...
    buttonWithLabel_GoToMainMenu.setLabelText(touchgfx::TypedText(T_SINGLEUSEID4847));
    ...
    buttonWithLabel_Graph.setLabelText(touchgfx::TypedText(T_SINGLEUSEID4848));
    ...
    buttonWithLabel_Settings.setLabelText(touchgfx::TypedText(T_SINGLEUSEID4849));
    ...
    Unicode::snprintf(textArea_Parameter1NameBuffer, TEXTAREA_PARAMETER1NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4851).getText());
    textArea_Parameter1Name.setWildcard(textArea_Parameter1NameBuffer);
    textArea_Parameter1Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4850));
    ...
    Unicode::snprintf(textArea_Parameter2NameBuffer, TEXTAREA_PARAMETER2NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4853).getText());
    textArea_Parameter2Name.setWildcard(textArea_Parameter2NameBuffer);
    textArea_Parameter2Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4852));
    ...
    Unicode::snprintf(textArea_Parameter3NameBuffer, TEXTAREA_PARAMETER3NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4855).getText());
    textArea_Parameter3Name.setWildcard(textArea_Parameter3NameBuffer);
    textArea_Parameter3Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4854));
    ...
    Unicode::snprintf(textArea_Parameter4NameBuffer, TEXTAREA_PARAMETER4NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4857).getText());
    textArea_Parameter4Name.setWildcard(textArea_Parameter4NameBuffer);
    textArea_Parameter4Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4856));
    ...
    Unicode::snprintf(textArea_Parameter1ValueBuffer, TEXTAREA_PARAMETER1VALUE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4859).getText());
    textArea_Parameter1Value.setWildcard(textArea_Parameter1ValueBuffer);
    textArea_Parameter1Value.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4858));
    ...
    Unicode::snprintf(textArea_Parameter2ValueBuffer, TEXTAREA_PARAMETER2VALUE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4861).getText());
    textArea_Parameter2Value.setWildcard(textArea_Parameter2ValueBuffer);
    textArea_Parameter2Value.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4860));
    ...
    Unicode::snprintf(textArea_Parameter3ValueBuffer, TEXTAREA_PARAMETER3VALUE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4863).getText());
    textArea_Parameter3Value.setWildcard(textArea_Parameter3ValueBuffer);
    textArea_Parameter3Value.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4862));
    ...
    Unicode::snprintf(textArea_Parameter4ValueBuffer, TEXTAREA_PARAMETER4VALUE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4865).getText());
    textArea_Parameter4Value.setWildcard(textArea_Parameter4ValueBuffer);
    textArea_Parameter4Value.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4864));
    ...
    buttonWithLabel_Info.setLabelText(touchgfx::TypedText(T_SINGLEUSEID4867));
...
void Screen_Module3_DataViewBase::setupScreen()
{

}

void Screen_Module3_DataViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    else if (&src == &buttonWithLabel_Graph)
    {
        ...
        //When buttonWithLabel_Graph clicked change screen to Screen_Module3_Graph
    ...
    else if (&src == &buttonWithLabel_Settings)
    {
        ...
        //When buttonWithLabel_Settings clicked change screen to Screen_Module3_Settings
        //Go to Screen_Module3_Settings with no screen transition
        application().gotoScreen_Module3_SettingsScreenNoTransition();
    }
    ...
    else if (&src == &buttonWithLabel_Info)
    {
        ...
        //When buttonWithLabel_Info clicked change screen to Screen_Module3_Info
        //Go to Screen_Module3_Info with no screen transition
        application().gotoScreen_Module3_InfoScreenNoTransition();
    }
}
