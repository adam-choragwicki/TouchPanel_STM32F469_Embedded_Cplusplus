...
Screen_Module3_SettingsViewBase::Screen_Module3_SettingsViewBase() :
    buttonCallback(this, &Screen_Module3_SettingsViewBase::buttonCallbackHandler),
    radioButtonSelectedCallback(this, &Screen_Module3_SettingsViewBase::radioButtonSelectedCallbackHandler),
    updateItemCallback(this, &Screen_Module3_SettingsViewBase::updateItemCallbackHandler)
{
    ...
    buttonWithLabel_SetValue.setLabelText(touchgfx::TypedText(T_SINGLEUSEID5258));
    ...
    Unicode::snprintf(textArea_SettableParameter1NameBuffer, TEXTAREA_SETTABLEPARAMETER1NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5260).getText());
    textArea_SettableParameter1Name.setWildcard(textArea_SettableParameter1NameBuffer);
    textArea_SettableParameter1Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5259));
    ...
    textArea_ValueToSet.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5261));
    ...
    textArea_ParameterToSet.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5262));
    ...
    textArea_Title.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5263));
    ...
    buttonWithLabel_Back.setLabelText(touchgfx::TypedText(T_SINGLEUSEID5264));
    ...
    Unicode::snprintf(textArea_CPU_UsageBuffer, TEXTAREA_CPU_USAGE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5266).getText());
    textArea_CPU_Usage.setWildcard(textArea_CPU_UsageBuffer);
    textArea_CPU_Usage.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5265));
    ...
    buttonWithLabel_EnableParameter.setLabelText(touchgfx::TypedText(T_SINGLEUSEID5267));
    ...
    buttonWithLabel_DisableParameter.setLabelText(touchgfx::TypedText(T_SINGLEUSEID5268));
    ...
    Unicode::snprintf(textArea_SettableParameter2NameBuffer, TEXTAREA_SETTABLEPARAMETER2NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5270).getText());
    textArea_SettableParameter2Name.setWildcard(textArea_SettableParameter2NameBuffer);
    textArea_SettableParameter2Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5269));
    ...
    Unicode::snprintf(textArea_SettableParameter3NameBuffer, TEXTAREA_SETTABLEPARAMETER3NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5272).getText());
    textArea_SettableParameter3Name.setWildcard(textArea_SettableParameter3NameBuffer);
    textArea_SettableParameter3Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5271));
    ...
    Unicode::snprintf(textArea_SettableParameter4NameBuffer, TEXTAREA_SETTABLEPARAMETER4NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5274).getText());
    textArea_SettableParameter4Name.setWildcard(textArea_SettableParameter4NameBuffer);
    textArea_SettableParameter4Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5273));
    ...
    Unicode::snprintf(textArea_SettableParameter5NameBuffer, TEXTAREA_SETTABLEPARAMETER5NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5276).getText());
    textArea_SettableParameter5Name.setWildcard(textArea_SettableParameter5NameBuffer);
    textArea_SettableParameter5Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5275));
    ...
    Unicode::snprintf(textArea_SettableParameter6NameBuffer, TEXTAREA_SETTABLEPARAMETER6NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5278).getText());
    textArea_SettableParameter6Name.setWildcard(textArea_SettableParameter6NameBuffer);
    textArea_SettableParameter6Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5277));
    ...
    Unicode::snprintf(textArea_SettableParameter7NameBuffer, TEXTAREA_SETTABLEPARAMETER7NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5280).getText());
    textArea_SettableParameter7Name.setWildcard(textArea_SettableParameter7NameBuffer);
    textArea_SettableParameter7Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5279));
    ...
    Unicode::snprintf(textArea_SettableParameter8NameBuffer, TEXTAREA_SETTABLEPARAMETER8NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5282).getText());
    textArea_SettableParameter8Name.setWildcard(textArea_SettableParameter8NameBuffer);
    textArea_SettableParameter8Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5281));
    ...
    Unicode::snprintf(textArea_SettableParameter9NameBuffer, TEXTAREA_SETTABLEPARAMETER9NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5284).getText());
    textArea_SettableParameter9Name.setWildcard(textArea_SettableParameter9NameBuffer);
    textArea_SettableParameter9Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5283));
    ...
    Unicode::snprintf(textArea_SettableParameter10NameBuffer, TEXTAREA_SETTABLEPARAMETER10NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5286).getText());
    textArea_SettableParameter10Name.setWildcard(textArea_SettableParameter10NameBuffer);
    textArea_SettableParameter10Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5285));
    ...
    textArea_Plus.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5287));
    ...
    textArea_Minus.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5288));
...
void Screen_Module3_SettingsViewBase::setupScreen()
{
...
void Screen_Module3_SettingsViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void Screen_Module3_SettingsViewBase::radioButtonSelectedCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void Screen_Module3_SettingsViewBase::updateItemCallbackHandler(touchgfx::DrawableListItemsInterface* items, int16_t containerIndex, int16_t itemIndex)
{
