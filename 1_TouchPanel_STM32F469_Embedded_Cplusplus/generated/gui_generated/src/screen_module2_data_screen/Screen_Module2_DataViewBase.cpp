    ...
    buttonCallback(this, &Screen_Module2_DataViewBase::buttonCallbackHandler)
{
    ...
    Unicode::snprintf(textArea_CPU_UsageBuffer, TEXTAREA_CPU_USAGE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID754).getText());
    textArea_CPU_Usage.setWildcard(textArea_CPU_UsageBuffer);
    textArea_CPU_Usage.setTypedText(touchgfx::TypedText(T_SINGLEUSEID753));
    ...
    buttonWithLabel_GoToMainMenu.setLabelText(touchgfx::TypedText(T_SINGLEUSEID755));
    ...
    buttonWithLabel_Graph.setLabelText(touchgfx::TypedText(T_SINGLEUSEID756));
    ...
    buttonWithLabel_Settings.setLabelText(touchgfx::TypedText(T_SINGLEUSEID757));
    ...
    Unicode::snprintf(textArea_Parameter1NameBuffer, TEXTAREA_PARAMETER1NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID759).getText());
    textArea_Parameter1Name.setWildcard(textArea_Parameter1NameBuffer);
    textArea_Parameter1Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID758));
    ...
    Unicode::snprintf(textArea_Parameter2NameBuffer, TEXTAREA_PARAMETER2NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID761).getText());
    textArea_Parameter2Name.setWildcard(textArea_Parameter2NameBuffer);
    textArea_Parameter2Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID760));
    ...
    Unicode::snprintf(textArea_Parameter3NameBuffer, TEXTAREA_PARAMETER3NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID763).getText());
    textArea_Parameter3Name.setWildcard(textArea_Parameter3NameBuffer);
    textArea_Parameter3Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID762));
    ...
    Unicode::snprintf(textArea_Parameter4NameBuffer, TEXTAREA_PARAMETER4NAME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID765).getText());
    textArea_Parameter4Name.setWildcard(textArea_Parameter4NameBuffer);
    textArea_Parameter4Name.setTypedText(touchgfx::TypedText(T_SINGLEUSEID764));
    ...
    Unicode::snprintf(textArea_Parameter1ValueBuffer, TEXTAREA_PARAMETER1VALUE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID767).getText());
    textArea_Parameter1Value.setWildcard(textArea_Parameter1ValueBuffer);
    textArea_Parameter1Value.setTypedText(touchgfx::TypedText(T_SINGLEUSEID766));
    ...
    Unicode::snprintf(textArea_Parameter2ValueBuffer, TEXTAREA_PARAMETER2VALUE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID769).getText());
    textArea_Parameter2Value.setWildcard(textArea_Parameter2ValueBuffer);
    textArea_Parameter2Value.setTypedText(touchgfx::TypedText(T_SINGLEUSEID768));
    ...
    Unicode::snprintf(textArea_Parameter3ValueBuffer, TEXTAREA_PARAMETER3VALUE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID771).getText());
    textArea_Parameter3Value.setWildcard(textArea_Parameter3ValueBuffer);
    textArea_Parameter3Value.setTypedText(touchgfx::TypedText(T_SINGLEUSEID770));
    ...
    Unicode::snprintf(textArea_Parameter4ValueBuffer, TEXTAREA_PARAMETER4VALUE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID773).getText());
    textArea_Parameter4Value.setWildcard(textArea_Parameter4ValueBuffer);
    textArea_Parameter4Value.setTypedText(touchgfx::TypedText(T_SINGLEUSEID772));
    ...
    textArea_ShowAll.setTypedText(touchgfx::TypedText(T_SINGLEUSEID9582));
    ...
    textArea_Title.setTypedText(touchgfx::TypedText(T_SINGLEUSEID774));
    ...
    buttonWithLabel_Info.setLabelText(touchgfx::TypedText(T_SINGLEUSEID775));
...
void Screen_Module2_DataViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    else if (&src == &buttonWithLabel_Info)
    {
        ...
        //When buttonWithLabel_Info clicked change screen to Screen_Module2_Info
        //Go to Screen_Module2_Info with no screen transition
        application().gotoScreen_Module2_InfoScreenNoTransition();
    }
}
