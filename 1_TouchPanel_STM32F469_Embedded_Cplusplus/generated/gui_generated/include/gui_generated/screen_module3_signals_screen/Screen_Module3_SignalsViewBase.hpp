...
/*********************************************************************************/
#ifndef SCREEN_MODULE3_SIGNALSVIEWBASE_HPP
#define SCREEN_MODULE3_SIGNALSVIEWBASE_HPP
...
class Screen_Module3_SignalsViewBase : public touchgfx::View<Screen_Module3_SignalsPresenter>
{
public:
    Screen_Module3_SignalsViewBase();
    virtual ~Screen_Module3_SignalsViewBase() {}
    virtual void setupScreen();

    virtual void scrollWheel_MaxDigit10UpdateItem(DigitTemplate& item, int16_t itemIndex)
    {
        // Override and implement this function in Screen_Module3_Signals
    }
...
private:
     ...
     */
    touchgfx::Callback<Screen_Module3_SignalsViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Screen_Module3_SignalsViewBase, const touchgfx::Slider&, int> sliderValueChangedCallback;
    touchgfx::Callback<Screen_Module3_SignalsViewBase, touchgfx::DrawableListItemsInterface*, int16_t, int16_t> updateItemCallback;
...
#endif // SCREEN_MODULE3_SIGNALSVIEWBASE_HPP
