...
/*********************************************************************************/
#ifndef SCREEN_MODULE2_SIGNALSVIEWBASE_HPP
#define SCREEN_MODULE2_SIGNALSVIEWBASE_HPP
...
{
public:
    Screen_Module2_SignalsViewBase();
    virtual ~Screen_Module2_SignalsViewBase() {}
    virtual void setupScreen();

    virtual void scrollWheel_MaxDigit10UpdateItem(DigitTemplate& item, int16_t itemIndex)
    {
        // Override and implement this function in Screen_Module2_Signals
    }
...
private:
     ...
     */
    touchgfx::Callback<Screen_Module2_SignalsViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Screen_Module2_SignalsViewBase, const touchgfx::Slider&, int> sliderValueChangedCallback;
    touchgfx::Callback<Screen_Module2_SignalsViewBase, touchgfx::DrawableListItemsInterface*, int16_t, int16_t> updateItemCallback;
...
#endif // SCREEN_MODULE2_SIGNALSVIEWBASE_HPP
